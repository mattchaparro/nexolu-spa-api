...
{
    public function test_las_horas_en_punto_no_llevan_minutos(): void
    {
        $this->assertSame('3 pm', HoraLegible::deTexto('15:00'));
        $this->assertSame('10 am', HoraLegible::deTexto('10:00'));
    }

    public function test_los_minutos_aparecen_solo_cuando_los_hay(): void
    {
    ...
    public function test_el_mediodia_y_la_medianoche_son_las_12(): void
    {
        ...
        $this->assertSame('12 pm', HoraLegible::deTexto('12:00'));
    ...
    public function test_convierte_desde_una_fecha_en_la_zona_del_negocio(): void
    {
        ...
        $this->assertSame('3 pm', HoraLegible::de($momento, 'America/Bogota'));
    }
}
